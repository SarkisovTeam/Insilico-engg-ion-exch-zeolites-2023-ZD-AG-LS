...
%% State all input parameters for the simulation
    ...
    epsilon_p   = 0.35                  ;   % Porosity of the pellet
    ro_crys     = 1815;                     % Density of the crystal
    ro_s        = ro_crys*(1-epsilon_p) ;   % Density of the adsorbent particle (not crystal density)[kg/m^3]
